			...
			<div class="docs-tabs_content reports">
				<div class="active" data-tab-content="docs">
					<div class="docs">
						...
						<?php if (have_rows('fajly', 'option')) : ?>
							<div class="tab-title">
								<h3>Документы для заполнения</h3>
							</div>
							<ul class="docs-wrap">
								<?php while (have_rows('fajly', 'option')) : the_row();
						...
						<div class="reports_header">
							...
							<div class="reports_header-tabs">
								...
								while (have_rows('otchety', $user)) : the_row(); ?>
									<div class="reports_header-tabs-item <?php if ($count == 1) {
																				echo 'active';
																			}; ?>" data-period="<?php echo $count; ?>">
						...
						<div class="reports_content">
							...
							while (have_rows('otchety', $user)) : the_row(); ?>
								<div class="<?php if ($count == 1) {
												echo 'active';
											}; ?>" data-period-content="<?php echo $count; ?>">
										...
										<ul class="reports_list">
											<?php while (have_rows('dokumenty')) : the_row(); ?>
												<li class="reports_list-item bb">
													...
													$link = wp_get_attachment_url($doc);
													?>
													<a href="<?php echo $link; ?>" class="item-title">
														<?php the_sub_field('nazvanie_dokumenta'); ?> <span class="reports_list-download">скачать</span>
													</a>
